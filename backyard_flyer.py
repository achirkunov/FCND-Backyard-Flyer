...
class BackyardFlyer(Drone):
    ...
    def local_position_callback(self):
        ...
        if self.flight_state == States.WAYPOINT:
            ...
            local_pos[2] = -1.0 * local_pos[2]

            distance = np.linalg.norm(self.target_position[0:2] - local_pos[0:2])
            ...
            #print("Local Position[2]:", self.local_position[2])
            #print("Global Position[2]:", self.global_position[2])
